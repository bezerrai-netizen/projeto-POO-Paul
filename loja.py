...
class Loja:
    ...
    def __init__(self):
        self.__estoque = [Comida("Batata", 10, 20), Brinquedo("Bola", 30, 25), Pocao("Poção de Vida", 50, "saude", 30), Comida("salsicha", 20, 30), Brinquedo("Estatua de Demetrios", 10000, 100)]
